        ...
        <div style={{ ...s.card, ...(done ? s.cardDone : {}) }}>
          {done ? (
            ...
            <>
              ...
              {/* Google Sign In */}
              <a
                href={`${process.env.REACT_APP_API_URL?.replace('/api','') || 'https://auction-app-m9xw.onrender.com'}/api/auth/google`}
                style={s.googleBtn}>
...
const s = {
  ...
  googleBtn:   { display:'flex', alignItems:'center', justifyContent:'center', gap:12, padding:'13px', background:'#fff', border:'none', borderRadius:12, color:'#3c4043', fontSize:14, fontWeight:600, cursor:'pointer', textDecoration:'none', transition:'all .2s', boxShadow:'0 2px 8px rgba(0,0,0,.3)' },
